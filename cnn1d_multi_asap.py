...
model.add_node(Embedding(20, pos_embd_dim, input_length=maxlen),
...
# - no predict_classes
classes = model.predict({'input': X_test, 'posinput': pos_test}, batch_size=batch_size)['output'].argmax(axis=1)
